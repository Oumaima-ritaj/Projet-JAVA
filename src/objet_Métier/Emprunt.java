...
public class Emprunt {
	...
	public Emprunt ( int idExemplaire, String titre ,String nom,String prenom ,String date_Emprunt, String dateRe_theo, String dateRe_Eff )
	{
...
//	}
	...
	{
		return " Emprunt :  id_Oeuvre = "+this.id_Exemplaire+", titre= "+this.titre+", nom="+this.nom_Usager+", prenom="+this.prenom_Usager+", Date d'Emprunt = "+this.date_Emprunt+", Date retour theorique = "+this.dateRetour_theo+", Date retour Effective = "+this.dateRetour_Eff;                                                             
	}
