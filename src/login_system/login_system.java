	...
	public login_system() {
		...
		label.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent arg0) {
	            ...
	            login_system.this.setLocation(x - xx, y - xy);  
			}
		});
		label.setBounds(-38, 0, 384, 438);
		label.setVerticalAlignment(SwingConstants.TOP);
		label.setIcon(new ImageIcon(login_system.class.getResource("/images/bg.jpg")));
		panel.add(label);
		...
		lblUsername.setBounds(395, 74, 114, 14);
